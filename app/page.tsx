    ...
    <AppShell>
      <div className="space-y-12">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="group card-hover bg-white rounded-2xl border border-gray-200/50 p-8 shadow-soft animate-slide-up">
            ...
            <h3 className="mt-6 text-xl font-bold text-gray-900">{t('roots.title')}</h3>
            <p className="mt-3 text-gray-600 leading-relaxed">
              Explore word roots including prefixes, suffixes, and base forms with detailed examples and etymology.
            </p>
            <Link href={ROUTES.roots} className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-primary-600 hover:text-primary-700 transition-colors">
              Explore Roots
          ...
          <div className="group card-hover bg-white rounded-2xl border border-gray-200/50 p-8 shadow-soft animate-slide-up" style={{ animationDelay: '0.1s' }}>
            ...
            <h3 className="mt-6 text-xl font-bold text-gray-900">{t('vocabulary.title')}</h3>
            <p className="mt-3 text-gray-600 leading-relaxed">
              Master essential words organized by categories with IPA pronunciation and contextual examples.
            </p>
            <Link href={ROUTES.vocabulary} className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-primary-600 hover:text-primary-700 transition-colors">
              Browse Vocabulary
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
          ...
          <div className="group card-hover bg-white rounded-2xl border border-gray-200/50 p-8 shadow-soft animate-slide-up sm:col-span-2 lg:col-span-1" style={{ animationDelay: '0.2s' }}>
            ...
            <h3 className="mt-6 text-xl font-bold text-gray-900">{t('search.title')}</h3>
            <p className="mt-3 text-gray-600 leading-relaxed">
              Search across roots and vocabulary with intelligent filters for quick and precise results.
            </p>
            <Link href={ROUTES.search} className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-primary-600 hover:text-primary-700 transition-colors">
              Start Searching
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
        ...
        {/* About Section */}
        <div className="rounded-3xl bg-white border border-gray-200 p-8 shadow-soft animate-slide-up" style={{ animationDelay: '0.3s' }}>
          <div className="text-center space-y-4">
            ...
            <h3 className="text-2xl font-bold text-gray-900">About This Platform</h3>
