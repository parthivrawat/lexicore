...
export function FeaturedWord() {
  ...
  const featuredWord = useMemo(() => {
    // Only support English and French for Word of the Day
    const supportedLanguage = (learningLanguage === 'english' || learningLanguage === 'french') 
      ? learningLanguage 
      : 'english';
    return getWordOfTheDay(supportedLanguage);
  }, [learningLanguage]);

  if (!featuredWord || !featuredWord.etymology) return null;
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="space-y-2">
              {featuredWord.etymology.timeline.slice(0, 3).map((stage: any, idx: number) => (
