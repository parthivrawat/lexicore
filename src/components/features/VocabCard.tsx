      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-bold text-gray-900 group-hover:text-success-600 transition-colors">
                {word.word}
              </h3>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">{word.meaning}</p>
          
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <span className="inline-flex items-center rounded-full bg-success-100 px-3 py-1 text-xs font-semibold text-success-800">
