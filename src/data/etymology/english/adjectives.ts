...
export const adjectivesEtymology: Record<string, Etymology> = {
    ...
    timeline: [
      {
        ...
        form: 'uggligr',
        period: 'Viking age',
        meaning: 'fearsome, dreadful',
      },
      {
        language: 'Middle English',
        form: 'ugly, uggly',
        period: '13th century',
        meaning: 'fearsome, repulsive',
      },
    ...
    timeline: [
      {
        ...
        form: 'importare',
        period: 'Roman era',
        meaning: 'to bring in, to signify',
      },
    ...
    timeline: [
      {
        ...
        form: '*reg-',
        period: 'Prehistoric',
        meaning: 'to move in a straight line, to rule',
      },
      {
        language: 'Proto-Germanic',
        form: '*rehtaz',
    ...
    timeline: [
      {
        ...
        form: '*wrang-',
        period: 'c. 500 BC',
        meaning: 'crooked, twisted',
      },
      {
        language: 'Old English',
        form: 'wrang',
        period: 'Before 12th century',
        meaning: 'crooked, wrong',
      },
      {
        language: 'Middle English',
        form: 'wrong, wrang',
  ...
  word_cheap: {
    ...
    timeline: [
      {
        ...
        form: 'ceap',
        period: 'Before 12th century',
        meaning: 'market, trade, bargain',
      },
      {
        language: 'Middle English',
        form: 'cheep, cheap',
        period: '12th-15th century',
        meaning: 'bargain, low price',
      },
    ...
    notes:
      'From Old English "ceap" meaning market or trade, evolved to mean "low price" from "good bargain".',
  },
    ...
    timeline: [
      {
        ...
        form: '*kunjaz',
        period: 'c. 500 BC',
        meaning: 'kin, family, race',
      },
      {
        language: 'Old English',
        form: 'cynd',
        period: 'Before 12th century',
        meaning: 'kin, nature, kind',
      },
      {
        language: 'Middle English',
        form: 'kinde, kind',
    ...
    timeline: [
      {
        ...
        form: 'smeartan',
        period: 'Before 12th century',
        meaning: 'to cause pain, to sting',
      },
      {
        language: 'Middle English',
        form: 'smart, smert',
        period: '13th century',
        meaning: 'painful, sharp',
      },
    ...
    timeline: [
      {
        ...
        form: 'bisig',
        period: 'Before 12th century',
        meaning: 'anxious, careful',
      },
      {
        language: 'Middle English',
        form: 'busy, busi',
        period: '14th century',
        meaning: 'occupied, attentive',
      },
