...
export const greetingsEtymology: Record<string, Etymology> = {
    ...
    timeline: [
      {
        ...
        form: 'thankō',
        period: 'Pre-5th century',
        meaning: 'thought, gratitude',
      },
      {
        language: 'Old English',
        form: 'þancian',
        period: 'Before 12th century',
        meaning: 'to think, to give thanks',
      },
      {
        language: 'Middle English',
        form: 'thanken',
  ...
  word_thanks: {
    ...
    notes:
      'Informal form of "thank you", from the same root meaning "to think" or "to give thanks".',
  },
    ...
    timeline: [
      {
        ...
        form: 'placere',
        period: 'Roman era',
        meaning: 'to please, to be agreeable',
      },
      {
        language: 'Middle English',
        form: 'plesen, please',
  ...
  word_sorry: {
    ...
    timeline: [
      {
        ...
        form: 'sarig',
        period: 'Before 12th century',
        meaning: 'painful, sorry',
      },
      {
        language: 'Middle English',
        form: 'sory, sorry',
        period: '15th century',
        meaning: 'sorrowful, apologetic',
      },
    ...
    notes:
      'From Old English "sarig" meaning "painful" or "sore", later specialized to express apology.',
  },
  ...
  word_excuse_me: {
    ...
    notes:
      'From Latin "excusare" meaning "to release" or "to pardon", used to politely ask for attention or forgiveness.',
  },
  ...
  word_pardon: {
    ...
    timeline: [
      ...
      },
      {
        ...
        form: 'pardon',
        period: '15th century',
        meaning: 'forgiveness/request to repeat',
      },
    ],
    cognates: [
    ...
    notes:
      'From Latin "per" (through) + "donare" (to give), literally meaning "to give completely".',
  },
  ...
  word_welcome: {
    ...
    timeline: [
      {
        ...
        form: 'wilcuma',
        period: 'Before 12th century',
        meaning: 'welcome guest',
      },
      {
        language: 'Middle English',
        form: 'welcome, wilcome',
        period: '12th-15th century',
        meaning: 'welcome',
      },
    ...
    notes:
      'From Old English "wilcuma" meaning "desired guest", from "will" (desire) + "cuma" (guest).',
  },
  ...
  word_congratulations: {
    ...
    timeline: [
      {
        language: 'Latin',
        form: 'congratulationem',
        period: 'Roman era',
        meaning: 'congratulation, joy',
      },
      {
        language: 'Middle English',
        form: 'congratulacioun',
    ...
    notes:
      'From Latin "congratulari" meaning "to rejoice together", from "con" (together) + "gratulari" (to give thanks).',
  },
  ...
  word_how_are_you: {
    ...
    notes:
      'Standard greeting inquiring about someone\'s well-being, evolved from earlier forms like "how do you do".',
  },
    ...
    timeline: [
      {
        ...
        form: 'nice to mete',
        period: '14th-15th century',
        meaning: 'pleasant to meet',
      },
      {
        language: 'Modern English',
        form: 'nice to meet you',
        period: '19th century',
        meaning: 'introduction greeting',
      },
    ],
    cognates: [
  ...
  word_take_care: {
    ...
    notes:
      'Originally meant "to exercise caution", now commonly used as a farewell meaning "take care of yourself".',
  },
  ...
  word_cheers: {
    ...
    notes:
      'From "cheer" meaning "face" or "expression", evolved to mean "good cheer" and now used as a toast, thanks, or farewell.',
  },
};
