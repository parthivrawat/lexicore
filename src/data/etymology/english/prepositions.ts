...
export const prepositionsEtymology: Record<string, Etymology> = {
  ...
  word_with: {
    ...
    yearOfOrigin: 'Prehistoric',
    timeline: [
      { language: 'Proto-Indo-European', form: '*wi-', period: 'Prehistoric', meaning: 'apart, away' },
      { language: 'Proto-Germanic', form: '*with', period: 'c. 500 BC', meaning: 'with, against' },
      { language: 'Old English', form: 'wiþ', period: 'Before 12th century', meaning: 'against, with' },
      { language: 'Middle English', form: 'with, with', period: '12th-15th century', meaning: 'with' },
  ...
  word_from: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'fram', period: 'Before 12th century', meaning: 'from, forward' },
      { language: 'Middle English', form: 'from, fro', period: '12th-15th century', meaning: 'from' },
  ...
  word_without: {
    ...
    timeline: [
      { language: 'Old English', form: 'wiþūtan', period: 'Before 12th century', meaning: 'without, outside' },
      { language: 'Middle English', form: 'without, withuten', period: '12th-15th century', meaning: 'without' },
  ...
  word_for: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'for', period: 'Before 12th century', meaning: 'for, before' },
  ...
  word_about: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'abūtan', period: 'Before 12th century', meaning: 'around, about' },
      { language: 'Middle English', form: 'about, abute', period: '12th-15th century', meaning: 'about' },
  ...
  word_into: {
    ...
    timeline: [
      { language: 'Old English', form: 'in', period: 'Before 12th century', meaning: 'in' },
      { language: 'Middle English', form: 'into, intō', period: '12th-15th century', meaning: 'into' },
  ...
  word_out_of: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'out of, out of', period: '12th-15th century', meaning: 'out of' },
  ...
  word_over: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'ofer', period: 'Before 12th century', meaning: 'over, above' },
      { language: 'Middle English', form: 'over, over', period: '12th-15th century', meaning: 'over' },
  ...
  word_under: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'under', period: 'Before 12th century', meaning: 'under, below' },
      { language: 'Middle English', form: 'under, under', period: '12th-15th century', meaning: 'under' },
  ...
  word_above: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'abufan', period: 'Before 12th century', meaning: 'above, on top' },
      { language: 'Middle English', form: 'above, aboven', period: '12th-15th century', meaning: 'above' },
  ...
  word_below: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'behlūfan', period: 'Before 12th century', meaning: 'below, beneath' },
      { language: 'Middle English', form: 'below, bilowen', period: '12th-15th century', meaning: 'below' },
  ...
  word_between: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'betwēonan', period: 'Before 12th century', meaning: 'between, among' },
      { language: 'Middle English', form: 'betwene, bitwix', period: '12th-15th century', meaning: 'between' },
    ...
    notes: 'Compound of "by" + "two" (twain), literally meaning "by two" or "in the middle of two".'
  },
  ...
  word_among: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'ongemang', period: 'Before 12th century', meaning: 'among, in company' },
      { language: 'Middle English', form: 'among, ongemang', period: '12th-15th century', meaning: 'among' },
  ...
  word_through: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'through, thorugh', period: '12th-15th century', meaning: 'through' },
  ...
  word_across: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'on gegean', period: 'Before 12th century', meaning: 'across, over' },
      { language: 'Middle English', form: 'across, a-cros', period: '12th-15th century', meaning: 'across' },
    ...
    notes: 'Compound of "on" + "cross", originally meant "in the form of a cross" or "from side to side".'
  },
  ...
  word_around: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'und', period: 'Before 12th century', meaning: 'around, about' },
      { language: 'Middle English', form: 'around, aronde', period: '12th-15th century', meaning: 'around' },
  ...
  word_behind: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'behindan', period: 'Before 12th century', meaning: 'behind, after' },
      { language: 'Middle English', form: 'behind, bihind', period: '12th-15th century', meaning: 'behind' },
  ...
  word_in_front_of: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'beforan', period: 'Before 12th century', meaning: 'before, in front' },
      { language: 'Middle English', form: 'in front of, biforen', period: '12th-15th century', meaning: 'in front of' },
      { language: 'Modern English', form: 'in front of', period: '15th century', meaning: 'in front of' }
    ],
    cognates: [
  ...
  word_next_to: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'nēah', period: 'Before 12th century', meaning: 'near, next' },
      { language: 'Middle English', form: 'next to, neihst to', period: '12th-15th century', meaning: 'next to' },
  ...
  word_near: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'near, ner', period: '12th-15th century', meaning: 'near' },
  ...
  word_before: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*fur', period: 'c. 500 BC', meaning: 'before, in front' },
      { language: 'Old English', form: 'beforan', period: 'Before 12th century', meaning: 'before' },
      { language: 'Middle English', form: 'before, biforen', period: '12th-15th century', meaning: 'before' },
  ...
  word_after: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'æfter', period: 'Before 12th century', meaning: 'after, behind' },
      { language: 'Middle English', form: 'after, after', period: '12th-15th century', meaning: 'after' },
  ...
  word_during: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'during, durenge', period: '14th-15th century', meaning: 'during' },
  ...
  word_since: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Middle English', form: 'sithen, sith', period: '14th-15th century', meaning: 'since' },
  ...
  word_until: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'until, til', period: '13th-15th century', meaning: 'until' },
  ...
  word_beyond: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'begeondan', period: 'Before 12th century', meaning: 'beyond, on the other side' },
      { language: 'Middle English', form: 'beyond, biyonde', period: '12th-15th century', meaning: 'beyond' },
  ...
  word_within: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'wiþinnan', period: 'Before 12th century', meaning: 'within, inside' },
      { language: 'Middle English', form: 'within, withinnen', period: '12th-15th century', meaning: 'within' },
  ...
  word_toward: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'toweard', period: 'Before 12th century', meaning: 'toward, facing' },
      { language: 'Middle English', form: 'toward, towarde', period: '12th-15th century', meaning: 'toward' },
  ...
  word_against: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Middle English', form: 'ageynes, ayens', period: '14th-15th century', meaning: 'against' },
  ...
  word_along: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Middle English', form: 'along, alonge', period: '14th-15th century', meaning: 'along' },
  ...
  word_down: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'down, doun', period: '12th-15th century', meaning: 'down' },
  ...
  word_inside: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Middle English', form: 'inside, insyde', period: '14th-15th century', meaning: 'inside' },
  ...
  word_outside: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Middle English', form: 'outside, outsyde', period: '14th-15th century', meaning: 'outside' },
