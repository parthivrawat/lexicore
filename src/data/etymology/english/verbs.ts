...
export const verbsEtymology: Record<string, Etymology> = {
  word_go: {
    ...
    timeline: [
      { language: 'Proto-Indo-European', form: '*ghā-', period: 'Prehistoric', meaning: 'to go, to leave' },
      ...
      { language: 'Middle English', form: 'gon, go', period: '12th-15th century', meaning: 'to go' },
  ...
  word_see: {
    ...
    yearOfOrigin: 'Prehistoric',
    timeline: [
      { language: 'Proto-Indo-European', form: '*sekw-', period: 'Prehistoric', meaning: 'to see, to follow' },
  ...
  word_make: {
    ...
    yearOfOrigin: 'Prehistoric',
    timeline: [
      { language: 'Proto-Indo-European', form: '*mag-', period: 'Prehistoric', meaning: 'to knead, to fashion' },
      { language: 'Proto-Germanic', form: '*makōną', period: 'c. 500 BC', meaning: 'to make' },
      { language: 'Old English', form: 'macian', period: 'Before 12th century', meaning: 'to make' },
      { language: 'Middle English', form: 'maken', period: '12th-15th century', meaning: 'to make' },
  ...
  word_be: {
    ...
    yearOfOrigin: 'Prehistoric',
    timeline: [
      { language: 'Proto-Indo-European', form: '*bheu-', period: 'Prehistoric', meaning: 'to become, to grow' },
      ...
      { language: 'Middle English', form: 'been, be', period: '12th-15th century', meaning: 'to be' },
    ...
    notes: 'Irregular verb with forms am, is, are, was, were, been. From a root meaning "to grow" or "to become".'
  },
  ...
  word_have: {
    ...
    timeline: [
      { language: 'Proto-Germanic', form: '*habjaną', period: 'c. 500 BC', meaning: 'to have, to hold' },
      { language: 'Old English', form: 'habban', period: 'Before 12th century', meaning: 'to have' },
      { language: 'Middle English', form: 'haven, have', period: '12th-15th century', meaning: 'to have' },
  ...
  word_do: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*dōną', period: 'c. 500 BC', meaning: 'to do, to place' },
      { language: 'Old English', form: 'dōn', period: 'Before 12th century', meaning: 'to do' },
      { language: 'Middle English', form: 'don, do', period: '12th-15th century', meaning: 'to do' },
    ...
    notes: 'Irregular verb with forms do, does, did, done. From a root meaning "to place" or "to put".'
  },
  ...
  word_say: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'sayen, say', period: '12th-15th century', meaning: 'to say' },
  ...
  word_get: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'geten, get', period: '13th-15th century', meaning: 'to get' },
  ...
  word_know: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'cnāwan', period: 'Before 12th century', meaning: 'to know' },
      { language: 'Middle English', form: 'knowen, know', period: '12th-15th century', meaning: 'to know' },
    ...
    notes: 'Irregular verb with forms know, knows, knew, known. From a root meaning "to recognize" or "to perceive".'
  },
  ...
  word_take: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*tēkaną', period: 'c. 500 BC', meaning: 'to touch, to take' },
      { language: 'Old English', form: 'tācian', period: 'Before 12th century', meaning: 'to take' },
      { language: 'Middle English', form: 'taken, take', period: '12th-15th century', meaning: 'to take' },
  ...
  word_come: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'comen, come', period: '12th-15th century', meaning: 'to come' },
    ...
    notes: 'Irregular verb with forms come, comes, came, come. From a root meaning "to move toward".'
  },
  ...
  word_think: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'þencan', period: 'Before 12th century', meaning: 'to think' },
      { language: 'Middle English', form: 'thinken, think', period: '12th-15th century', meaning: 'to think' },
  ...
  word_look: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*lōkōną', period: 'c. 500 BC', meaning: 'to look, to see' },
      { language: 'Old English', form: 'lōcian', period: 'Before 12th century', meaning: 'to look' },
      { language: 'Middle English', form: 'looken, look', period: '12th-15th century', meaning: 'to look' },
  ...
  word_want: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'wanten, want', period: '13th-15th century', meaning: 'to want' },
  ...
  word_give: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'giefan', period: 'Before 12th century', meaning: 'to give' },
      { language: 'Middle English', form: 'given, give', period: '12th-15th century', meaning: 'to give' },
    ...
    notes: 'Irregular verb with forms give, gives, gave, given. From a root meaning "to grant" or "to bestow".'
  },
  ...
  word_use: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'usen, use', period: '14th-15th century', meaning: 'to use' },
  ...
  word_find: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'findan', period: 'Before 12th century', meaning: 'to find' },
      { language: 'Middle English', form: 'finden, find', period: '12th-15th century', meaning: 'to find' },
    ...
    notes: 'Irregular verb with forms find, finds, found, found. From a root meaning "to encounter" or "to come upon".'
  },
  ...
  word_tell: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*taljaną', period: 'c. 500 BC', meaning: 'to count, to tell' },
      { language: 'Old English', form: 'tellan', period: 'Before 12th century', meaning: 'to count, to tell' },
      { language: 'Middle English', form: 'tellen, tell', period: '12th-15th century', meaning: 'to tell' },
  ...
  word_ask: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*aiskōną', period: 'c. 500 BC', meaning: 'to ask, to request' },
      { language: 'Old English', form: 'āscian', period: 'Before 12th century', meaning: 'to ask' },
      { language: 'Middle English', form: 'asken, ask', period: '12th-15th century', meaning: 'to ask' },
  ...
  word_work: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'worken, work', period: '12th-15th century', meaning: 'to work' },
  ...
  word_seem: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'semen, seem', period: '13th-15th century', meaning: 'to seem' },
  ...
  word_feel: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*fōlijaną', period: 'c. 500 BC', meaning: 'to feel, to touch' },
      { language: 'Old English', form: 'fēlan', period: 'Before 12th century', meaning: 'to feel' },
      { language: 'Middle English', form: 'felen, feel', period: '12th-15th century', meaning: 'to feel' },
  ...
  word_try: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'trien, try', period: '13th-15th century', meaning: 'to try' },
  ...
  word_leave: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*laibijaną', period: 'c. 500 BC', meaning: 'to leave, to remain' },
      { language: 'Old English', form: 'lǣfan', period: 'Before 12th century', meaning: 'to leave' },
      { language: 'Middle English', form: 'leven, leave', period: '12th-15th century', meaning: 'to leave' },
  ...
  word_call: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'callen, call', period: '13th-15th century', meaning: 'to call' },
  ...
  word_help: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'helpan', period: 'Before 12th century', meaning: 'to help' },
      { language: 'Middle English', form: 'helpen, help', period: '12th-15th century', meaning: 'to help' },
  ...
  word_turn: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'turnen, turn', period: '13th-15th century', meaning: 'to turn' },
  ...
  word_start: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Old French', form: 'estartir', period: '14th century', meaning: 'to startle, to start' },
      { language: 'Middle English', form: 'starten, start', period: '14th-15th century', meaning: 'to start' },
  ...
  word_show: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*skawijaną', period: 'c. 500 BC', meaning: 'to show, to see' },
      { language: 'Old English', form: 'scēawian', period: 'Before 12th century', meaning: 'to look at, to show' },
      { language: 'Middle English', form: 'showen, show', period: '12th-15th century', meaning: 'to show' },
  ...
  word_hear: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'hīeran', period: 'Before 12th century', meaning: 'to hear' },
      { language: 'Middle English', form: 'heren, hear', period: '12th-15th century', meaning: 'to hear' },
    ...
    notes: 'Irregular verb with forms hear, hears, heard, heard. From a root meaning "to perceive sound".'
  },
  ...
  word_play: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*pleganą', period: 'c. 500 BC', meaning: 'to play, to exercise' },
      { language: 'Old English', form: 'plegan', period: 'Before 12th century', meaning: 'to play' },
      { language: 'Middle English', form: 'playen, play', period: '12th-15th century', meaning: 'to play' },
  ...
  word_run: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'rinnen, run', period: '12th-15th century', meaning: 'to run' },
    ...
    notes: 'Irregular verb with forms run, runs, ran, run. From a root meaning "to flow" or "to move quickly".'
  },
  ...
  word_move: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'moven, move', period: '14th-15th century', meaning: 'to move' },
  ...
  word_live: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*libaną', period: 'c. 500 BC', meaning: 'to live, to remain' },
      { language: 'Old English', form: 'līfian', period: 'Before 12th century', meaning: 'to live' },
      { language: 'Middle English', form: 'liven, live', period: '12th-15th century', meaning: 'to live' },
  ...
  word_believe: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*ga-laubjaną', period: 'c. 500 BC', meaning: 'to believe, to trust' },
      { language: 'Old English', form: 'gelyfan', period: 'Before 12th century', meaning: 'to believe' },
      { language: 'Middle English', form: 'beliven, believe', period: '12th-15th century', meaning: 'to believe' },
      { language: 'Modern English', form: 'believe', period: '15th century', meaning: 'to believe' }
    ],
    cognates: [
  ...
  word_hold: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*haldaną', period: 'c. 500 BC', meaning: 'to hold, to keep' },
      { language: 'Old English', form: 'healdan', period: 'Before 12th century', meaning: 'to hold' },
      { language: 'Middle English', form: 'holden, hold', period: '12th-15th century', meaning: 'to hold' },
    ...
    notes: 'Irregular verb with forms hold, holds, held, held. From a root meaning "to guard" or "to keep".'
  },
  ...
  word_bring: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'bringan', period: 'Before 12th century', meaning: 'to bring' },
      { language: 'Middle English', form: 'bringen, bring', period: '12th-15th century', meaning: 'to bring' },
    ...
    notes: 'Irregular verb with forms bring, brings, brought, brought. From a root meaning "to carry" or "to transport".'
  },
  ...
  word_happen: {
    ...
    yearOfOrigin: 'c. 13th century',
    timeline: [
      { language: 'Old Norse', form: 'happa', period: 'Viking age', meaning: 'to happen, to have good luck' },
      { language: 'Middle English', form: 'happen, hap', period: '13th-15th century', meaning: 'to happen' },
  ...
  word_write: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*wrītaną', period: 'c. 500 BC', meaning: 'to write, to scratch' },
      { language: 'Old English', form: 'wrītan', period: 'Before 12th century', meaning: 'to write' },
      { language: 'Middle English', form: 'writen, write', period: '12th-15th century', meaning: 'to write' },
    ...
    notes: 'Irregular verb with forms write, writes, wrote, written. Originally meant "to scratch" or "to carve".'
  },
  ...
  word_provide: {
    ...
    timeline: [
      { language: 'Latin', form: 'providere', period: 'Roman era', meaning: 'to foresee, to provide' },
      { language: 'Middle English', form: 'providen, provide', period: '15th century', meaning: 'to provide' },
      { language: 'Modern English', form: 'provide', period: '16th century', meaning: 'to provide' }
    ],
    cognates: [
  ...
  word_sit: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'sitten, sit', period: '12th-15th century', meaning: 'to sit' },
    ...
    notes: 'Irregular verb with forms sit, sits, sat, sat. From a root meaning "to settle" or "to occupy a place".'
  },
  ...
  word_stand: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'standan', period: 'Before 12th century', meaning: 'to stand' },
      { language: 'Middle English', form: 'standen, stand', period: '12th-15th century', meaning: 'to stand' },
    ...
    notes: 'Irregular verb with forms stand, stands, stood, stood. From a root meaning "to be upright" or "to remain".'
  },
  ...
  word_lose: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*lausijaną', period: 'c. 500 BC', meaning: 'to lose, to perish' },
      { language: 'Old English', form: 'losian', period: 'Before 12th century', meaning: 'to lose' },
      { language: 'Middle English', form: 'losen, lose', period: '12th-15th century', meaning: 'to lose' },
    ...
    notes: 'Irregular verb with forms lose, loses, lost, lost. From a root meaning "to perish" or "to destroy".'
  },
  ...
  word_pay: {
    ...
    yearOfOrigin: 'c. 13th century',
    timeline: [
      { language: 'Old French', form: 'paier', period: '13th century', meaning: 'to pay, to satisfy' },
      { language: 'Middle English', form: 'payen, pay', period: '13th-15th century', meaning: 'to pay' },
    ...
    notes: 'From Old French "paier" meaning "to satisfy" or "to pacify", specialized to monetary payment.'
  },
  ...
  word_meet: {
    ...
    timeline: [
      { language: 'Old English', form: 'mētan', period: 'Before 12th century', meaning: 'to meet, to find' },
      { language: 'Middle English', form: 'meten, meet', period: '12th-15th century', meaning: 'to meet' },
    ...
    notes: 'Irregular verb with forms meet, meets, met, met. From a root meaning "to come upon" or "to encounter".'
  },
  ...
  word_include: {
    ...
    yearOfOrigin: 'c. 15th century',
    timeline: [
      { language: 'Latin', form: 'inclaudere', period: 'Roman era', meaning: 'to enclose, to include' },
      { language: 'Middle English', form: 'includen, include', period: '15th century', meaning: 'to include' },
      { language: 'Modern English', form: 'include', period: '16th century', meaning: 'to include' }
    ],
    cognates: [
  ...
  word_continue: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'continuen, continue', period: '14th-15th century', meaning: 'to continue' },
      { language: 'Modern English', form: 'continue', period: '15th century', meaning: 'to continue' }
    ],
    cognates: [
  ...
  word_set: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*satijaną', period: 'c. 500 BC', meaning: 'to set, to place' },
      { language: 'Old English', form: 'settan', period: 'Before 12th century', meaning: 'to set' },
      { language: 'Middle English', form: 'setten, set', period: '12th-15th century', meaning: 'to set' },
    ...
    notes: 'Irregular verb with forms set, sets, set, set. From a root meaning "to cause to sit" or "to place".'
  },
  ...
  word_learn: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*liznōną', period: 'c. 500 BC', meaning: 'to learn, to know' },
      { language: 'Old English', form: 'leornian', period: 'Before 12th century', meaning: 'to learn' },
      { language: 'Middle English', form: 'lernen, learn', period: '12th-15th century', meaning: 'to learn' },
  ...
  word_change: {
    ...
    yearOfOrigin: 'c. 13th century',
    timeline: [
      { language: 'Old French', form: 'changier', period: '13th century', meaning: 'to change, to exchange' },
      { language: 'Middle English', form: 'changen, change', period: '13th-15th century', meaning: 'to change' },
  ...
  word_lead: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*laidijaną', period: 'c. 500 BC', meaning: 'to lead, to guide' },
      { language: 'Old English', form: 'lǣdan', period: 'Before 12th century', meaning: 'to lead' },
      { language: 'Middle English', form: 'leden, lead', period: '12th-15th century', meaning: 'to lead' },
    ...
    notes: 'Irregular verb with forms lead, leads, led, led. From a root meaning "to go" or "to travel".'
  },
  ...
  word_understand: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'understandan', period: 'Before 12th century', meaning: 'to understand' },
      { language: 'Middle English', form: 'understanden, understand', period: '12th-15th century', meaning: 'to understand' },
      { language: 'Modern English', form: 'understand', period: '15th century', meaning: 'to understand' }
    ],
    cognates: [
  ...
  word_watch: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*wakōną', period: 'c. 500 BC', meaning: 'to watch, to be awake' },
      { language: 'Old English', form: 'wæccan', period: 'Before 12th century', meaning: 'to watch' },
      { language: 'Middle English', form: 'watchen, watch', period: '12th-15th century', meaning: 'to watch' },
  ...
  word_follow: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'folgian', period: 'Before 12th century', meaning: 'to follow' },
      { language: 'Middle English', form: 'folwen, follow', period: '12th-15th century', meaning: 'to follow' },
  ...
  word_stop: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Old French', form: 'estopper', period: '14th century', meaning: 'to stop, to plug' },
      { language: 'Middle English', form: 'stoppen, stop', period: '14th-15th century', meaning: 'to stop' },
  ...
  word_create: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'createn, create', period: '15th century', meaning: 'to create' },
  ...
  word_speak: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'sprecan', period: 'Before 12th century', meaning: 'to speak' },
      { language: 'Middle English', form: 'speaken, speak', period: '12th-15th century', meaning: 'to speak' },
    ...
    notes: 'Irregular verb with forms speak, speaks, spoke, spoken. From a root meaning "to utter" or "to make noise".'
  },
  ...
  word_read: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*rēdaną', period: 'c. 500 BC', meaning: 'to advise, to read' },
      { language: 'Old English', form: 'rǣdan', period: 'Before 12th century', meaning: 'to read, to advise' },
      { language: 'Middle English', form: 'reden, read', period: '12th-15th century', meaning: 'to read' },
    ...
    notes: 'Irregular verb with forms read, reads, read, read. Originally meant "to advise" or "to counsel".'
  },
  ...
  word_spend: {
    ...
    yearOfOrigin: 'c. 13th century',
    timeline: [
      { language: 'Old French', form: 'despendre', period: '13th century', meaning: 'to spend, to weigh out' },
      { language: 'Middle English', form: 'spenden, spend', period: '13th-15th century', meaning: 'to spend' },
  ...
  word_grow: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'grōwan', period: 'Before 12th century', meaning: 'to grow' },
      { language: 'Middle English', form: 'growen, grow', period: '12th-15th century', meaning: 'to grow' },
    ...
    notes: 'Irregular verb with forms grow, grows, grew, grown. From a root meaning "to become green" or "to flourish".'
  },
  ...
  word_open: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'openian', period: 'Before 12th century', meaning: 'to open' },
      { language: 'Middle English', form: 'openen, open', period: '12th-15th century', meaning: 'to open' },
  ...
  word_walk: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*walkaną', period: 'c. 500 BC', meaning: 'to walk, to roll' },
      { language: 'Old English', form: 'wealcan', period: 'Before 12th century', meaning: 'to walk, to roll' },
      { language: 'Middle English', form: 'walken, walk', period: '12th-15th century', meaning: 'to walk' },
  ...
  word_win: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*winnaną', period: 'c. 500 BC', meaning: 'to win, to strive' },
      { language: 'Old English', form: 'winnan', period: 'Before 12th century', meaning: 'to win, to struggle' },
      { language: 'Middle English', form: 'winnen, win', period: '12th-15th century', meaning: 'to win' },
    ...
    notes: 'Irregular verb with forms win, wins, won, won. From a root meaning "to strive" or "to struggle".'
  },
  ...
  word_teach: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*taikijaną', period: 'c. 500 BC', meaning: 'to show, to teach' },
      { language: 'Old English', form: 'tǣcan', period: 'Before 12th century', meaning: 'to teach' },
      { language: 'Middle English', form: 'techen, teach', period: '12th-15th century', meaning: 'to teach' },
  ...
  word_offer: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'offren, offer', period: '14th-15th century', meaning: 'to offer' },
  ...
  word_remember: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Latin', form: 'rememorari', period: 'Roman era', meaning: 'to remember, to recall' },
      { language: 'Middle English', form: 'rememberen, remember', period: '14th-15th century', meaning: 'to remember' },
      { language: 'Modern English', form: 'remember', period: '15th century', meaning: 'to remember' }
    ],
    cognates: [
  ...
  word_love: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*lubōną', period: 'c. 500 BC', meaning: 'to love, to desire' },
      { language: 'Old English', form: 'lufian', period: 'Before 12th century', meaning: 'to love' },
      { language: 'Middle English', form: 'loven, love', period: '12th-15th century', meaning: 'to love' },
  ...
  word_consider: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Latin', form: 'considerare', period: 'Roman era', meaning: 'to consider, to examine' },
      { language: 'Middle English', form: 'consideren, consider', period: '14th-15th century', meaning: 'to consider' },
      { language: 'Modern English', form: 'consider', period: '15th century', meaning: 'to consider' }
    ],
    cognates: [
  ...
  word_appear: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Latin', form: 'apparere', period: 'Roman era', meaning: 'to appear, to become visible' },
      { language: 'Middle English', form: 'apparen, appear', period: '14th-15th century', meaning: 'to appear' },
  ...
  word_buy: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'buggen, buy', period: '12th-15th century', meaning: 'to buy' },
    ...
    notes: 'Irregular verb with forms buy, buys, bought, bought. From a root meaning "to purchase" or "to acquire".'
  },
  ...
  word_wait: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'waiten, wait', period: '13th-15th century', meaning: 'to wait' },
  ...
  word_serve: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'serven, serve', period: '13th-15th century', meaning: 'to serve' },
  ...
  word_die: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'steorfan', period: 'Before 12th century', meaning: 'to die' },
      { language: 'Middle English', form: 'dien, die', period: '12th-15th century', meaning: 'to die' },
    ...
    notes: 'Irregular verb with forms die, dies, died, died. From a root meaning "to perish" or "to pass away".'
  },
  ...
  word_send: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*sandijaną', period: 'c. 500 BC', meaning: 'to send, to go' },
      { language: 'Old English', form: 'sendan', period: 'Before 12th century', meaning: 'to send' },
      { language: 'Middle English', form: 'senden, send', period: '12th-15th century', meaning: 'to send' },
    ...
    notes: 'Irregular verb with forms send, sends, sent, sent. From a root meaning "to go" or "to journey".'
  },
  ...
  word_expect: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'expecten, expect', period: '16th century', meaning: 'to expect' },
  ...
  word_build: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*būaną', period: 'c. 500 BC', meaning: 'to build, to dwell' },
      { language: 'Old English', form: 'būldan', period: 'Before 12th century', meaning: 'to build' },
      { language: 'Middle English', form: 'bilden, build', period: '12th-15th century', meaning: 'to build' },
  ...
  word_stay: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'stayen, stay', period: '13th-15th century', meaning: 'to stay' },
  ...
  word_fall: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'feallan', period: 'Before 12th century', meaning: 'to fall' },
      { language: 'Middle English', form: 'fallen, fall', period: '12th-15th century', meaning: 'to fall' },
    ...
    notes: 'Irregular verb with forms fall, falls, fell, fallen. From a root meaning "to drop" or "to descend".'
  },
  ...
  word_cut: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'cutten, cut', period: '12th-15th century', meaning: 'to cut' },
  ...
  word_reach: {
    ...
    yearOfOrigin: 'c. 13th century',
    timeline: [
      { language: 'Old French', form: 'reacher', period: '13th century', meaning: 'to reach, to stretch' },
      { language: 'Middle English', form: 'rechen, reach', period: '13th-15th century', meaning: 'to reach' },
  ...
  word_kill: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'cyllan', period: 'Before 12th century', meaning: 'to kill, to strike' },
      { language: 'Middle English', form: 'killen, kill', period: '12th-15th century', meaning: 'to kill' },
  ...
  word_remain: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'remainen, remain', period: '14th-15th century', meaning: 'to remain' },
  ...
  word_suggest: {
    ...
    yearOfOrigin: 'c. 16th century',
    timeline: [
      { language: 'Latin', form: 'suggerere', period: 'Roman era', meaning: 'to suggest, to propose' },
      { language: 'Middle English', form: 'suggesten, suggest', period: '16th century', meaning: 'to suggest' },
      { language: 'Modern English', form: 'suggest', period: '16th century', meaning: 'to suggest' }
    ],
    cognates: [
  ...
  word_raise: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'raisen, raise', period: '13th-15th century', meaning: 'to raise' },
  ...
  word_pass: {
    ...
    yearOfOrigin: 'c. 13th century',
    timeline: [
      { language: 'Old French', form: 'passer', period: '13th century', meaning: 'to pass, to step' },
      { language: 'Middle English', form: 'passen, pass', period: '13th-15th century', meaning: 'to pass' },
  ...
  word_sell: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'sellan', period: 'Before 12th century', meaning: 'to sell, to give' },
      { language: 'Middle English', form: 'sellen, sell', period: '12th-15th century', meaning: 'to sell' },
    ...
    notes: 'Irregular verb with forms sell, sells, sold, sold. Originally meant "to give" or "to hand over".'
  },
  ...
  word_require: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'requiren, require', period: '14th-15th century', meaning: 'to require' },
      { language: 'Modern English', form: 'require', period: '15th century', meaning: 'to require' }
    ],
    cognates: [
  ...
  word_report: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Latin', form: 'reportare', period: 'Roman era', meaning: 'to report, to carry back' },
      { language: 'Middle English', form: 'reporten, report', period: '14th-15th century', meaning: 'to report' },
  ...
  word_decide: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Latin', form: 'decidere', period: 'Roman era', meaning: 'to decide, to cut off' },
      { language: 'Middle English', form: 'deciden, decide', period: '14th-15th century', meaning: 'to decide' },
  ...
  word_pull: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'pullen, pull', period: '13th-15th century', meaning: 'to pull' },
  ...
  word_push: {
    ...
    yearOfOrigin: 'c. 13th century',
    timeline: [
      { language: 'Old French', form: 'pousser', period: '13th century', meaning: 'to push, to thrust' },
      { language: 'Middle English', form: 'pushen, push', period: '13th-15th century', meaning: 'to push' },
  ...
  word_jump: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'jumpen, jump', period: '15th century', meaning: 'to jump' },
  ...
  word_dance: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'dancen, dance', period: '13th-15th century', meaning: 'to dance' },
  ...
  word_sing: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'singan', period: 'Before 12th century', meaning: 'to sing' },
      { language: 'Middle English', form: 'singen, sing', period: '12th-15th century', meaning: 'to sing' },
    ...
    notes: 'Irregular verb with forms sing, sings, sang, sung. From a root meaning "to make music with voice".'
  },
  ...
  word_eat: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'eten, eat', period: '12th-15th century', meaning: 'to eat' },
    ...
    notes: 'Irregular verb with forms eat, eats, ate, eaten. From a root meaning "to consume food".'
  },
  ...
  word_drink: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'drincan', period: 'Before 12th century', meaning: 'to drink' },
      { language: 'Middle English', form: 'drinken, drink', period: '12th-15th century', meaning: 'to drink' },
    ...
    notes: 'Irregular verb with forms drink, drinks, drank, drunk. From a root meaning "to swallow liquid".'
  },
  ...
  word_sleep: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'slǣpan', period: 'Before 12th century', meaning: 'to sleep' },
      { language: 'Middle English', form: 'slepen, sleep', period: '12th-15th century', meaning: 'to sleep' },
    ...
    notes: 'Irregular verb with forms sleep, sleeps, slept, slept. From a root meaning "to be slack" or "to be inactive".'
  },
  ...
  word_dream: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*draugmaz', period: 'c. 500 BC', meaning: 'deception, dream' },
      { language: 'Old English', form: 'drēam', period: 'Before 12th century', meaning: 'joy, music, dream' },
      { language: 'Middle English', form: 'dremen, dream', period: '12th-15th century', meaning: 'to dream' },
  ...
  word_wake: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*wakōną', period: 'c. 500 BC', meaning: 'to wake, to be awake' },
      { language: 'Old English', form: 'wæcnan', period: 'Before 12th century', meaning: 'to wake' },
      { language: 'Middle English', form: 'waken, wake', period: '12th-15th century', meaning: 'to wake' },
  ...
  word_cook: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'cooken, cook', period: '14th-15th century', meaning: 'to cook' },
  ...
  word_clean: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'clenen, clean', period: '13th-15th century', meaning: 'to clean' },
  ...
  word_wash: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'wascan', period: 'Before 12th century', meaning: 'to wash' },
      { language: 'Middle English', form: 'washen, wash', period: '12th-15th century', meaning: 'to wash' },
  ...
  word_dry: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'drȳgean', period: 'Before 12th century', meaning: 'to dry' },
      { language: 'Middle English', form: 'drien, dry', period: '12th-15th century', meaning: 'to dry' },
  ...
  word_drive: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'drīfan', period: 'Before 12th century', meaning: 'to drive, to rush' },
      { language: 'Middle English', form: 'driven, drive', period: '12th-15th century', meaning: 'to drive' },
    ...
    notes: 'Irregular verb with forms drive, drives, drove, driven. Originally meant "to rush" or "to force forward".'
  },
  ...
  word_ride: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'riden, ride', period: '12th-15th century', meaning: 'to ride' },
    ...
    notes: 'Irregular verb with forms ride, rides, rode, ridden. From a root meaning "to sit on" or "to travel".'
  },
  ...
  word_fly: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'flēogan', period: 'Before 12th century', meaning: 'to fly' },
      { language: 'Middle English', form: 'flyen, fly', period: '12th-15th century', meaning: 'to fly' },
    ...
    notes: 'Irregular verb with forms fly, flies, flew, flown. From a root meaning "to flee" or "to move through air".'
  },
  ...
  word_swim: {
    ...
    timeline: [
      ...
      { language: 'Old English', form: 'swimman', period: 'Before 12th century', meaning: 'to swim' },
      { language: 'Middle English', form: 'swimmen, swim', period: '12th-15th century', meaning: 'to swim' },
    ...
    notes: 'Irregular verb with forms swim, swims, swam, swum. From a root meaning "to move in water".'
  },
  ...
  word_climb: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'climban', period: 'Before 12th century', meaning: 'to climb' },
      { language: 'Middle English', form: 'climben, climb', period: '12th-15th century', meaning: 'to climb' },
  ...
  word_catch: {
    ...
    yearOfOrigin: 'c. 13th century',
    timeline: [
      { language: 'Old French', form: 'chacier', period: '13th century', meaning: 'to chase, to catch' },
      { language: 'Middle English', form: 'cachen, catch', period: '13th-15th century', meaning: 'to catch' },
  ...
  word_throw: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*þrawaną', period: 'c. 500 BC', meaning: 'to throw, to twist' },
      { language: 'Old English', form: 'þrāwan', period: 'Before 12th century', meaning: 'to throw' },
      { language: 'Middle English', form: 'throwen, throw', period: '12th-15th century', meaning: 'to throw' },
    ...
    notes: 'Irregular verb with forms throw, throws, threw, thrown. From a root meaning "to twist" or "to turn".'
  },
  ...
  word_hit: {
    ...
    yearOfOrigin: 'Before 12th century',
    timeline: [
      { language: 'Old English', form: 'hyttan', period: 'Before 12th century', meaning: 'to hit, to strike' },
      { language: 'Middle English', form: 'hitten, hit', period: '12th-15th century', meaning: 'to hit' },
  ...
  word_kick: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Middle English', form: 'kicken, kick', period: '14th-15th century', meaning: 'to kick' },
  ...
  word_bite: {
    ...
    timeline: [
      ...
      { language: 'Middle English', form: 'biten, bite', period: '12th-15th century', meaning: 'to bite' },
    ...
    notes: 'Irregular verb with forms bite, bites, bit, bitten. From a root meaning "to cut" or "to pierce with teeth".'
  },
  ...
  word_choose: {
    ...
    yearOfOrigin: 'c. 500 BC',
    timeline: [
      { language: 'Proto-Germanic', form: '*keusaną', period: 'c. 500 BC', meaning: 'to choose, to taste' },
      { language: 'Old English', form: 'cēosan', period: 'Before 12th century', meaning: 'to choose' },
      { language: 'Middle English', form: 'chēsen, choose', period: '12th-15th century', meaning: 'to choose' },
    ...
    notes: 'Irregular verb with forms choose, chooses, chose, chosen. From a root meaning "to taste" or "to test".'
  },
  ...
  word_pick: {
    ...
    yearOfOrigin: 'c. 14th century',
    timeline: [
      { language: 'Middle English', form: 'picken, pick', period: '14th-15th century', meaning: 'to pick, to pierce' },
    ...
    notes: 'From a root meaning "to pierce" or "to pull out", specialized to selecting or harvesting.'
  }
};
