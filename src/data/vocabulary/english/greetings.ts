...
export const greetings: VocabWord[] = [
  ...
  { id: 'word_good_afternoon', word: 'good afternoon', meaning: 'afternoon greeting', pronunciationVariants: [
    { accent: 'american', ipa: 'ɡʊd ˌæftərˈnuːn' },
    { accent: 'british', ipa: 'ɡʊd ˌɑːftəˈnuːn' },
    { accent: 'australian', ipa: 'ɡʊd ˌæftəˈnuːn' }
  ], category: 'greetings', examples: ['Good afternoon, everyone.', 'Good afternoon, sir.'] },
  { id: 'word_good_night', word: 'good night', meaning: 'night farewell', pronunciationVariants: [
    { accent: 'american', ipa: 'ɡʊd naɪt' },
    { accent: 'british', ipa: 'ɡʊd naɪt' },
    { accent: 'australian', ipa: 'ɡʊd naɪt' }
  ], category: 'greetings', examples: ['Good night, sleep well.', 'Good night and sweet dreams.'] },
  { id: 'word_welcome', word: 'welcome', meaning: 'greeting', pronunciationVariants: [
    { accent: 'american', ipa: 'ˈwɛlkəm' },
    { accent: 'british', ipa: 'ˈwɛlkəm' },
    { accent: 'australian', ipa: 'ˈwɛlkəm' }
  ], category: 'greetings', examples: ['Welcome to our home.', 'You\'re welcome.'] },
  { id: 'word_congratulations', word: 'congratulations', meaning: 'expression of praise', pronunciationVariants: [
    { accent: 'american', ipa: 'kənˌɡrætʃəˈleɪʃənz' },
    { accent: 'british', ipa: 'kənˌɡrætjʊˈleɪʃənz' },
    { accent: 'australian', ipa: 'kənˌɡrætʃəˈleɪʃənz' }
  ], category: 'greetings', examples: ['Congratulations on your success!', 'Congratulations to the winner.'] },
  { id: 'word_how_are_you', word: 'how are you', meaning: 'greeting/inquiry', pronunciationVariants: [
    { accent: 'american', ipa: 'haʊ ɑːr juː' },
    { accent: 'british', ipa: 'haʊ ɑː juː' },
    { accent: 'australian', ipa: 'haʊ ɑː juː' }
  ], category: 'greetings', examples: ['How are you doing?', 'How are you today?'] },
  { id: 'word_nice_to_meet_you', word: 'nice to meet you', meaning: 'introduction greeting', pronunciationVariants: [
    { accent: 'american', ipa: 'naɪs tuː miːt juː' },
    { accent: 'british', ipa: 'naɪs tuː miːt juː' },
    { accent: 'australian', ipa: 'naɪs tuː miːt juː' }
  ], category: 'greetings', examples: ['Nice to meet you!', 'It was nice to meet you.'] },
  { id: 'word_see_you_later', word: 'see you later', meaning: 'casual farewell', pronunciationVariants: [
    { accent: 'american', ipa: 'siː juː ˈleɪtər' },
    { accent: 'british', ipa: 'siː juː ˈleɪtə' },
    { accent: 'australian', ipa: 'siː juː ˈleɪtə' }
  ], category: 'greetings', examples: ['See you later!', 'I\'ll see you later.'] },
  { id: 'word_take_care', word: 'take care', meaning: 'farewell', pronunciationVariants: [
    { accent: 'american', ipa: 'teɪk kɛr' },
    { accent: 'british', ipa: 'teɪk kɛə' },
    { accent: 'australian', ipa: 'teɪk kɛə' }
  ], category: 'greetings', examples: ['Take care of yourself.', 'Take care!'] },
  { id: 'word_cheers', word: 'cheers', meaning: 'thanks/goodbye/toast', pronunciationVariants: [
    { accent: 'american', ipa: 'tʃɪrz' },
    { accent: 'british', ipa: 'tʃɪəz' },
    { accent: 'australian', ipa: 'tʃɪəz' }
  ], category: 'greetings', examples: ['Cheers for your help!', 'Cheers to the happy couple.'] }
];
