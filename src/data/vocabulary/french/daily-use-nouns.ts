...
export const dailyUseNouns: VocabWord[] = [
  {
    ...
    examples: ['Je vis dans une grande maison.', 'La maison est belle.'],
  },
  {
    id: 'word_famille',
    word: 'famille',
    ...
    category: 'daily-use-nouns',
    examples: ["J'aime ma famille.", 'La famille est importante.'],
  },
  {
    id: 'word_ami',
    word: 'ami',
  ...
  },
  {
    ...
    category: 'daily-use-nouns',
    examples: ["C'est ma meilleure amie.", 'Elle est une bonne amie.'],
  },
  {
    id: 'word_temps',
    word: 'temps',
    ...
    category: 'daily-use-nouns',
    examples: ["Je n'ai pas le temps.", 'Quel temps fait-il?'],
  },
  {
    id: 'word_jour',
    word: 'jour',
    ...
    category: 'daily-use-nouns',
    examples: ['Bonne journée!', 'Je travaille tous les jours.'],
  },
  {
    id: 'word_nuit',
    word: 'nuit',
    ...
    category: 'daily-use-nouns',
    examples: ['La nuit est étoilée.', 'Je dors la nuit.'],
  },
  {
    id: 'word_eau',
    word: 'eau',
    ...
    category: 'daily-use-nouns',
    examples: ["Je bois de l'eau.", "L'eau est froide."],
  },
  {
    id: 'word_pain',
    word: 'pain',
    ...
    category: 'daily-use-nouns',
    examples: ['Je mange du pain.', 'Le pain est frais.'],
  },
  {
    id: 'word_livre',
    word: 'livre',
    ...
    category: 'daily-use-nouns',
    examples: ['Je lis un livre.', 'Ce livre est intéressant.'],
  },
  {
    id: 'word_table',
    word: 'table',
    ...
    category: 'daily-use-nouns',
    examples: ['Mets le livre sur la table.', 'La table est mise.'],
  },
  {
    id: 'word_chaise',
    word: 'chaise',
    ...
    category: 'daily-use-nouns',
    examples: ['Assieds-toi sur cette chaise.', 'La chaise est confortable.'],
  },
  {
    id: 'word_porte',
    word: 'porte',
    ...
    category: 'daily-use-nouns',
    examples: ['Ouvre la porte.', 'La porte est fermée.'],
  },
  {
    id: 'word_fenêtre',
    word: 'fenêtre',
    ...
    category: 'daily-use-nouns',
    examples: ['Regarde par la fenêtre.', 'La fenêtre est ouverte.'],
  },
  {
    id: 'word_voiture',
    word: 'voiture',
    ...
    category: 'daily-use-nouns',
    examples: ['Je conduis ma voiture.', 'La voiture est rapide.'],
  },
  {
    id: 'word_école',
    word: 'école',
    ...
    category: 'daily-use-nouns',
    examples: ["Les enfants vont à l'école.", "L'école est grande."],
  },
  {
    id: 'word_travail',
    word: 'travail',
    ...
    category: 'daily-use-nouns',
    examples: ['Le travail est important.', 'Je vais au travail.'],
  },
  {
    id: 'word_argent',
    word: 'argent',
    ...
    category: 'daily-use-nouns',
    examples: ["Je n'ai pas d'argent.", "L'argent ne fait pas le bonheur."],
  },
  {
    id: 'word_nourriture',
    word: 'nourriture',
    ...
    category: 'daily-use-nouns',
    examples: ['La nourriture est bonne.', "J'aime la nourriture française."],
  },
  {
    id: 'word_ville',
    word: 'ville',
    ...
    category: 'daily-use-nouns',
    examples: ["J'habite dans une grande ville.", 'La ville est belle.'],
  },
  {
    id: 'word_pays',
    word: 'pays',
    ...
    category: 'daily-use-nouns',
    examples: ['La France est un beau pays.', "J'aime mon pays."],
  },
  {
    id: 'word_langue',
    word: 'langue',
    ...
    category: 'daily-use-nouns',
    examples: ["J'apprends une nouvelle langue.", 'La langue française est belle.'],
  },
  {
    id: 'word_mot',
    word: 'mot',
    ...
    category: 'daily-use-nouns',
    examples: ['Quel est ce mot?', "J'apprends un nouveau mot."],
  },
  {
    id: 'word_nom',
    word: 'nom',
    ...
    category: 'daily-use-nouns',
    examples: ['Quel est ton nom?', 'Mon nom est Pierre.'],
  },
  {
    id: 'word_année',
    word: 'année',
    ...
    category: 'daily-use-nouns',
    examples: ['Bonne année!', 'Cette année est importante.'],
  },
  {
    id: 'word_mois',
    word: 'mois',
    ...
    category: 'daily-use-nouns',
    examples: ["Il y a douze mois dans l'année.", 'Quel mois sommes-nous?'],
  },
  {
    id: 'word_semaine',
    word: 'semaine',
    ...
    category: 'daily-use-nouns',
    examples: ['Je travaille cinq jours par semaine.', 'Bonne semaine!'],
  },
  {
    id: 'word_lecon',
    word: 'leçon',
    ...
    category: 'daily-use-nouns',
    examples: ['La leçon était intéressante.', 'Apprends une leçon.'],
  },
  {
    id: 'word_air',
    word: 'air',
    ...
    category: 'daily-use-nouns',
    examples: ['Air frais.', "L'air est froid."],
  },
  {
    id: 'word_feu',
    word: 'feu',
    ...
    category: 'daily-use-nouns',
    examples: ['Fais un feu.', 'Sécurité incendie.'],
  },
  {
    id: 'word_lumiere',
    word: 'lumière',
    ...
    category: 'daily-use-nouns',
    examples: ['Allume la lumière.', 'Lumière naturelle.'],
  },
  {
    id: 'word_son',
    word: 'son',
    ...
    category: 'daily-use-nouns',
    examples: ['Bruit fort.', 'Le son de la musique.'],
  },
  {
    id: 'word_couleur',
    word: 'couleur',
    ...
    category: 'daily-use-nouns',
    examples: ['Couleur préférée.', 'Colorie le dessin.'],
  },
  {
    id: 'word_cote',
    word: 'côté',
    ...
    category: 'daily-use-nouns',
    examples: ['Côte à côte.', 'Les deux côtés.'],
  },
  {
    id: 'word_lit',
    word: 'lit',
    ...
    category: 'daily-use-nouns',
    examples: ['Va au lit.', 'Fais le lit.'],
  },
  {
    id: 'word_bureau',
    word: 'bureau',
    ...
    category: 'daily-use-nouns',
    examples: ['Nettoie ton bureau.', 'Le bureau est en désordre.'],
  },
  {
    id: 'word_mur',
    word: 'mur',
    ...
    category: 'daily-use-nouns',
    examples: ['Peins le mur.', 'Grimpe le mur.'],
  },
  {
    id: 'word_sol',
    word: 'sol',
    ...
    category: 'daily-use-nouns',
    examples: ['Nettoie le sol.', 'Premier étage.'],
  },
  {
    id: 'word_plafond',
    word: 'plafond',
    ...
    category: 'daily-use-nouns',
    examples: ['Plafond haut.', 'Touche le plafond.'],
  },
  {
    id: 'word_toit',
    word: 'toit',
    ...
    category: 'daily-use-nouns',
    examples: ['Sur le toit.', 'Répare le toit.'],
  },
  {
    id: 'word_jardin',
    word: 'jardin',
    ...
    category: 'daily-use-nouns',
    examples: ['Beau jardin.', 'Travaille dans le jardin.'],
  },
  {
    id: 'word_par',
    word: 'parc',
  ...
  },
  {
    ...
    category: 'daily-use-nouns',
    examples: ['Marche dans la rue.', 'Rue principale.'],
  },
  {
    id: 'word_route',
    word: 'route',
    ...
    category: 'daily-use-nouns',
    examples: ['Sur la route.', 'Voyage en route.'],
  },
  {
    id: 'word_pont',
    word: 'pont',
    ...
    category: 'daily-use-nouns',
    examples: ['Traverse le pont.', 'Construis un pont.'],
  },
  {
    id: 'word_riviere',
    word: 'rivière',
    ...
    category: 'daily-use-nouns',
    examples: ['Nage dans la rivière.', 'La rivière coule.'],
  },
  {
    id: 'word_ocean',
    word: 'océan',
    ...
    category: 'daily-use-nouns',
    examples: ["Vue sur l'océan.", 'Océan Pacifique.'],
  },
  {
    id: 'word_montagne',
    word: 'montagne',
    ...
    category: 'daily-use-nouns',
    examples: ['Grimpe la montagne.', 'Chaîne de montagnes.'],
  },
  {
    id: 'word_foret',
    word: 'forêt',
    ...
    category: 'daily-use-nouns',
    examples: ['Forêt profonde.', 'Animaux de la forêt.'],
  },
  {
    id: 'word_arbre',
    word: 'arbre',
    ...
    category: 'daily-use-nouns',
    examples: ['Plante un arbre.', "Grimpe l'arbre."],
  },
  {
    id: 'word_fleur',
    word: 'fleur',
    ...
    category: 'daily-use-nouns',
    examples: ['Belle fleur.', 'Sent les fleurs.'],
  },
  {
    id: 'word_animal',
    word: 'animal',
    ...
    category: 'daily-use-nouns',
    examples: ['Animal sauvage.', 'Refuge pour animaux.'],
  },
  {
    id: 'word_oiseau',
    word: 'oiseau',
    ...
    category: 'daily-use-nouns',
    examples: ['Regarde les oiseaux.', "Chant d'oiseau."],
  },
  {
    id: 'word_chien',
    word: 'chien',
    ...
    category: 'daily-use-nouns',
    examples: ['Promène le chien.', 'Un chien amical.'],
  },
  {
    id: 'word_chat',
    word: 'chat',
    ...
    category: 'daily-use-nouns',
    examples: ['Nourris le chat.', 'Le chat dort.'],
  },
  {
    id: 'word_cheval',
    word: 'cheval',
    ...
    category: 'daily-use-nouns',
    examples: ['Chevauche un cheval.', 'Courses de chevaux.'],
  },
  {
    id: 'word_vache',
    word: 'vache',
    ...
    category: 'daily-use-nouns',
    examples: ['Traite la vache.', 'La vache broute.'],
  },
  {
    id: 'word_poulet',
    word: 'poulet',
    ...
    category: 'daily-use-nouns',
    examples: ['Mange du poulet.', 'Le poulet pond des œufs.'],
  },
  {
    id: 'word_poisson',
    word: 'poisson',
    ...
    category: 'daily-use-nouns',
    examples: ['Attrape du poisson.', 'Les poissons nagent.'],
  },
  {
    id: 'word_soleil',
    word: 'soleil',
    ...
    category: 'daily-use-nouns',
    examples: ['Le soleil brille.', 'Lever du soleil.'],
  },
  {
    id: 'word_lune',
    word: 'lune',
    ...
    category: 'daily-use-nouns',
    examples: ['Pleine lune.', 'Clair de lune.'],
  },
  {
    id: 'word_etoile',
    word: 'étoile',
    ...
    category: 'daily-use-nouns',
    examples: ['Étoile brillante.', 'Regarder les étoiles.'],
  },
  {
    id: 'word_ciel',
    word: 'ciel',
    ...
    category: 'daily-use-nouns',
    examples: ['Ciel bleu.', 'Regarde le ciel.'],
  },
  {
    id: 'word_nuage',
    word: 'nuage',
    ...
    category: 'daily-use-nouns',
    examples: ['Nuage sombre.', 'Informatique en nuage.'],
  },
  {
    id: 'word_pluie',
    word: 'pluie',
    ...
    category: 'daily-use-nouns',
    examples: ['Pluie forte.', 'Imperméable.'],
  },
  {
    id: 'word_neige',
    word: 'neige',
    ...
    category: 'daily-use-nouns',
    examples: ['Neige blanche.', 'Joue dans la neige.'],
  },
  {
    id: 'word_vent',
    word: 'vent',
    ...
    category: 'daily-use-nouns',
    examples: ['Vent fort.', 'Énergie éolienne.'],
  },
  {
    id: 'word_terre',
    word: 'terre',
    ...
    category: 'daily-use-nouns',
    examples: ['Sauve la terre.', 'Jour de la Terre.'],
  },
];
