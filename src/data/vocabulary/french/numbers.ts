...
export const numbers: VocabWord[] = [
  ...
  { id: 'word_quatrieme', word: 'quatrième', meaning: 'fourth', pronunciationVariants: [
    { accent: 'parisian', ipa: 'katʁijɛm' },
    { accent: 'quebecois', ipa: 'katʁijɛm' },
    { accent: 'belgian', ipa: 'katʁijɛm' }
  ], category: 'numbers', examples: ['Quatrième place.', 'Le quatrième mois.'] },
  { id: 'word_cinquieme', word: 'cinquième', meaning: 'fifth', pronunciationVariants: [
    { accent: 'parisian', ipa: 'sɛ̃kjɛm' },
    { accent: 'quebecois', ipa: 'sɛ̃kjɛm' },
    { accent: 'belgian', ipa: 'sɛ̃kjɛm' }
  ], category: 'numbers', examples: ['Cinquième avenue.', 'C\'est le cinquième jour.'] },
  { id: 'word_sixieme', word: 'sixième', meaning: 'sixth', pronunciationVariants: [
    { accent: 'parisian', ipa: 'sizjɛm' },
    { accent: 'quebecois', ipa: 'sizjɛm' },
    { accent: 'belgian', ipa: 'sizjɛm' }
  ], category: 'numbers', examples: ['Sixième sens.', 'Le sixième chapitre.'] },
  { id: 'word_septieme', word: 'septième', meaning: 'seventh', pronunciationVariants: [
    { accent: 'parisian', ipa: 'sɛtjɛm' },
    { accent: 'quebecois', ipa: 'sɛtjɛm' },
    { accent: 'belgian', ipa: 'sɛtjɛm' }
  ], category: 'numbers', examples: ['Septième ciel.', 'Le septième jour.'] },
  { id: 'word_huitieme', word: 'huitième', meaning: 'eighth', pronunciationVariants: [
    { accent: 'parisian', ipa: 'ɥitjɛm' },
    { accent: 'quebecois', ipa: 'ɥitjɛm' },
    { accent: 'belgian', ipa: 'ɥitjɛm' }
  ], category: 'numbers', examples: ['Huitième note.', 'Le huitième mois.'] },
  { id: 'word_neuvieme', word: 'neuvième', meaning: 'ninth', pronunciationVariants: [
    { accent: 'parisian', ipa: 'nœvjɛm' },
    { accent: 'quebecois', ipa: 'nœvjɛm' },
    { accent: 'belgian', ipa: 'nœvjɛm' }
  ], category: 'numbers', examples: ['Neuvième inning.', 'Le neuvième cercle.'] },
  { id: 'word_dixieme', word: 'dixième', meaning: 'tenth', pronunciationVariants: [
    { accent: 'parisian', ipa: 'dizjɛm' },
    { accent: 'quebecois', ipa: 'dizjɛm' },
    { accent: 'belgian', ipa: 'dizjɛm' }
  ], category: 'numbers', examples: ['Dixième anniversaire.', 'Le dixième étage.'] },
  { id: 'word_zero', word: 'zéro', meaning: 'zero', pronunciationVariants: [
    { accent: 'parisian', ipa: 'zeʁo' },
    { accent: 'quebecois', ipa: 'zeʁo' },
    { accent: 'belgian', ipa: 'zeʁo' }
  ], category: 'numbers', examples: ['Zéro degré.', 'Zéro absolu.'] },
  { id: 'word_quarante', word: 'quarante', meaning: 'forty', pronunciationVariants: [
    { accent: 'parisian', ipa: 'kaʁɑ̃t' },
    { accent: 'quebecois', ipa: 'kaʁɑ̃t' },
    { accent: 'belgian', ipa: 'kaʁɑ̃t' }
  ], category: 'numbers', examples: ['Quarante winks.', 'Plus de quarante ans.'] },
  { id: 'word_cinquante', word: 'cinquante', meaning: 'fifty', pronunciationVariants: [
    { accent: 'parisian', ipa: 'sɛ̃kɑ̃t' },
    { accent: 'quebecois', ipa: 'sɛ̃kɑ̃t' },
    { accent: 'belgian', ipa: 'sɛ̃kɑ̃t' }
  ], category: 'numbers', examples: ['Cinquante états.', 'Cinquante-cinquante chance.'] },
  { id: 'word_soixante', word: 'soixante', meaning: 'sixty', pronunciationVariants: [
    { accent: 'parisian', ipa: 'swasɑ̃t' },
    { accent: 'quebecois', ipa: 'swasɑ̃t' },
    { accent: 'belgian', ipa: 'swasɑ̃t' }
  ], category: 'numbers', examples: ['Soixante minutes.', 'Soixante ans.'] },
  { id: 'word_soixante_dix', word: 'soixante-dix', meaning: 'seventy', pronunciationVariants: [
    { accent: 'parisian', ipa: 'swasɑ̃t dis' },
    { accent: 'quebecois', ipa: 'swasɑ̃t dis' },
    { accent: 'belgian', ipa: 'swasɑ̃t dis' }
  ], category: 'numbers', examples: ['Soixante-dix degrés.', 'Soixante-dix kilomètres.'] },
  { id: 'word_quatre_vingt', word: 'quatre-vingt', meaning: 'eighty', pronunciationVariants: [
    { accent: 'parisian', ipa: 'katʁ vɛ̃' },
    { accent: 'quebecois', ipa: 'katʁ vɛ̃' },
    { accent: 'belgian', ipa: 'katʁ vɛ̃' }
  ], category: 'numbers', examples: ['Quatre-vingt jours.', 'Quatre-vingt pour cent.'] },
  { id: 'word_quatre_vingt_dix', word: 'quatre-vingt-dix', meaning: 'ninety', pronunciationVariants: [
    { accent: 'parisian', ipa: 'katʁ vɛ̃ dis' },
    { accent: 'quebecois', ipa: 'katʁ vɛ̃ dis' },
    { accent: 'belgian', ipa: 'katʁ vɛ̃ dis' }
  ], category: 'numbers', examples: ['Quatre-vingt-dix degrés.', 'Quatre-vingt-dix pour cent.'] },
  { id: 'word_milliard', word: 'milliard', meaning: 'billion', pronunciationVariants: [
    { accent: 'parisian', ipa: 'miljaʁ' },
    { accent: 'quebecois', ipa: 'miljaʁ' },
    { accent: 'belgian', ipa: 'miljaʁ' }
  ], category: 'numbers', examples: ['Un milliard de dollars.', 'Des milliards d\'étoiles.'] },
  { id: 'word_demi', word: 'demi', meaning: 'half', pronunciationVariants: [
    { accent: 'parisian', ipa: 'dəmi' },
    { accent: 'quebecois', ipa: 'dəmi' },
    { accent: 'belgian', ipa: 'dəmi' }
  ], category: 'numbers', examples: ['Demi-heure.', 'À moitié vide.'] },
  { id: 'word_quart', word: 'quart', meaning: 'quarter', pronunciationVariants: [
    { accent: 'parisian', ipa: 'kaʁ' },
    { accent: 'quebecois', ipa: 'kaʁ' },
    { accent: 'belgian', ipa: 'kaʁ' }
  ], category: 'numbers', examples: ['Quart passé trois.', 'Un quart de dollar.'] },
  { id: 'word_double', word: 'double', meaning: 'double', pronunciationVariants: [
    { accent: 'parisian', ipa: 'dubl' },
    { accent: 'quebecois', ipa: 'dubl' },
    { accent: 'belgian', ipa: 'dubl' }
  ], category: 'numbers', examples: ['Double vérification.', 'Double la quantité.'] },
  { id: 'word_triple', word: 'triple', meaning: 'triple', pronunciationVariants: [
    { accent: 'parisian', ipa: 'tʁipl' },
    { accent: 'quebecois', ipa: 'tʁipl' },
    { accent: 'belgian', ipa: 'tʁipl' }
  ], category: 'numbers', examples: ['Triple menace.', 'Saut triple.'] }
];
