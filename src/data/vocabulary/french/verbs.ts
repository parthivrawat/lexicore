...
export const verbs: VocabWord[] = [
  ...
  { id: 'word_pousser', word: 'pousser', meaning: 'to push', pronunciationVariants: [
    { accent: 'parisian', ipa: 'puse' },
    { accent: 'quebecois', ipa: 'puse' },
    { accent: 'belgian', ipa: 'puse' }
  ], category: 'verbs', examples: ['Pousse le bouton.', 'Elle a poussé la porte.'] },
  { id: 'word_sauter', word: 'sauter', meaning: 'to jump', pronunciationVariants: [
    { accent: 'parisian', ipa: 'sote' },
    { accent: 'quebecois', ipa: 'sote' },
    { accent: 'belgian', ipa: 'sote' }
  ], category: 'verbs', examples: ['Saute par-dessus la clôture.', 'Le chat a sauté.'] },
  { id: 'word_danser', word: 'danser', meaning: 'to dance', pronunciationVariants: [
    { accent: 'parisian', ipa: 'dɑ̃se' },
    { accent: 'quebecois', ipa: 'dɑ̃se' },
    { accent: 'belgian', ipa: 'dɑ̃se' }
  ], category: 'verbs', examples: ['Dansons!', 'Elle danse magnifiquement.'] },
  { id: 'word_chanter', word: 'chanter', meaning: 'to sing', pronunciationVariants: [
    { accent: 'parisian', ipa: 'ʃɑ̃te' },
    { accent: 'quebecois', ipa: 'ʃɑ̃te' },
    { accent: 'belgian', ipa: 'ʃɑ̃te' }
  ], category: 'verbs', examples: ['Chante une chanson.', 'Elle chante dans le chœur.'] },
  { id: 'word_dormir', word: 'dormir', meaning: 'to sleep', pronunciationVariants: [
    { accent: 'parisian', ipa: 'dɔʁmiʁ' },
    { accent: 'quebecois', ipa: 'dɔʁmiʁ' },
    { accent: 'belgian', ipa: 'dɔʁmiʁ' }
  ], category: 'verbs', examples: ['Dors bien.', 'Elle a dormi huit heures.'] },
  { id: 'word_rever', word: 'rêver', meaning: 'to dream', pronunciationVariants: [
    { accent: 'parisian', ipa: 'ʁeve' },
    { accent: 'quebecois', ipa: 'ʁeve' },
    { accent: 'belgian', ipa: 'ʁeve' }
  ], category: 'verbs', examples: ['Rêve grand.', 'J\'ai rêvé de toi.'] },
  { id: 'word_se_reveiller', word: 'se réveiller', meaning: 'to wake up', pronunciationVariants: [
    { accent: 'parisian', ipa: 'sə ʁeveje' },
    { accent: 'quebecois', ipa: 'sə ʁeveje' },
    { accent: 'belgian', ipa: 'sə ʁeveje' }
  ], category: 'verbs', examples: ['Réveille-toi tôt.', 'Elle s\'est réveillée à l\'aube.'] },
  { id: 'word_cuisiner', word: 'cuisiner', meaning: 'to cook', pronunciationVariants: [
    { accent: 'parisian', ipa: 'kɥizine' },
    { accent: 'quebecois', ipa: 'kɥizine' },
    { accent: 'belgian', ipa: 'kɥizine' }
  ], category: 'verbs', examples: ['Cuisine le dîner.', 'Il cuisine de délicieux repas.'] },
  { id: 'word_nettoyer', word: 'nettoyer', meaning: 'to clean', pronunciationVariants: [
    { accent: 'parisian', ipa: 'netwaje' },
    { accent: 'quebecois', ipa: 'netwaje' },
    { accent: 'belgian', ipa: 'netwaje' }
  ], category: 'verbs', examples: ['Nettoie ta chambre.', 'Elle a nettoyé la maison.'] },
  { id: 'word_laver', word: 'laver', meaning: 'to wash', pronunciationVariants: [
    { accent: 'parisian', ipa: 'lave' },
    { accent: 'quebecois', ipa: 'lave' },
    { accent: 'belgian', ipa: 'lave' }
  ], category: 'verbs', examples: ['Lave tes mains.', 'Lave la vaisselle.'] },
  { id: 'word_secher', word: 'sécher', meaning: 'to dry', pronunciationVariants: [
    { accent: 'parisian', ipa: 'seʃe' },
    { accent: 'quebecois', ipa: 'seʃe' },
    { accent: 'belgian', ipa: 'seʃe' }
  ], category: 'verbs', examples: ['Sèche tes cheveux.', 'Les vêtements ont séché.'] },
  { id: 'word_conduire', word: 'conduire', meaning: 'to drive', pronunciationVariants: [
    { accent: 'parisian', ipa: 'kɔndɥiʁ' },
    { accent: 'quebecois', ipa: 'kɔndɥiʁ' },
    { accent: 'belgian', ipa: 'kɔndɥiʁ' }
  ], category: 'verbs', examples: ['Conduis prudemment.', 'Elle conduit au travail.'] },
  { id: 'word_marcher', word: 'marcher', meaning: 'to walk', pronunciationVariants: [
    { accent: 'parisian', ipa: 'maʁʃe' },
    { accent: 'quebecois', ipa: 'maʁʃe' },
    { accent: 'belgian', ipa: 'maʁʃe' }
  ], category: 'verbs', examples: ['Marche lentement.', 'Je marche tous les jours.'] },
  { id: 'word_voler', word: 'voler', meaning: 'to fly', pronunciationVariants: [
    { accent: 'parisian', ipa: 'vɔle' },
    { accent: 'quebecois', ipa: 'vɔle' },
    { accent: 'belgian', ipa: 'vɔle' }
  ], category: 'verbs', examples: ['Vole à Paris.', 'Les oiseaux volent sud en hiver.'] },
  { id: 'word_nager', word: 'nager', meaning: 'to swim', pronunciationVariants: [
    { accent: 'parisian', ipa: 'naʒe' },
    { accent: 'quebecois', ipa: 'naʒe' },
    { accent: 'belgian', ipa: 'naʒe' }
  ], category: 'verbs', examples: ['Nage à travers le lac.', 'Elle nage chaque matin.'] },
  { id: 'word_grimper', word: 'grimper', meaning: 'to climb', pronunciationVariants: [
    { accent: 'parisian', ipa: 'ɡʁɛ̃pe' },
    { accent: 'quebecois', ipa: 'ɡʁɛ̃pe' },
    { accent: 'belgian', ipa: 'ɡʁɛ̃pe' }
  ], category: 'verbs', examples: ['Grimpe la montagne.', 'Il a grimpé l\'échelle.'] },
  { id: 'word_tomber', word: 'tomber', meaning: 'to fall', pronunciationVariants: [
    { accent: 'parisian', ipa: 'tɔ̃be' },
    { accent: 'quebecois', ipa: 'tɔ̃be' },
    { accent: 'belgian', ipa: 'tɔ̃be' }
  ], category: 'verbs', examples: ['Ne tombe pas!', 'Les feuilles tombent en automne.'] },
  { id: 'word_attraper', word: 'attraper', meaning: 'to catch', pronunciationVariants: [
    { accent: 'parisian', ipa: 'atʁape' },
    { accent: 'quebecois', ipa: 'atʁape' },
    { accent: 'belgian', ipa: 'atʁape' }
  ], category: 'verbs', examples: ['Attrape la balle.', 'Elle a attrapé le train.'] },
  { id: 'word_lancer', word: 'lancer', meaning: 'to throw', pronunciationVariants: [
    { accent: 'parisian', ipa: 'lɑ̃se' },
    { accent: 'quebecois', ipa: 'lɑ̃se' },
    { accent: 'belgian', ipa: 'lɑ̃se' }
  ], category: 'verbs', examples: ['Lance la balle.', 'Il l\'a jeté.'] },
  { id: 'word_frapper', word: 'frapper', meaning: 'to hit', pronunciationVariants: [
    { accent: 'parisian', ipa: 'fʁape' },
    { accent: 'quebecois', ipa: 'fʁape' },
    { accent: 'belgian', ipa: 'fʁape' }
  ], category: 'verbs', examples: ['Frappe la cible.', 'La voiture a frappé le mur.'] },
  { id: 'word_coup_de_pied', word: 'donner un coup de pied', meaning: 'to kick', pronunciationVariants: [
    { accent: 'parisian', ipa: 'dɔne ku də pje' },
    { accent: 'quebecois', ipa: 'dɔne ku də pje' },
    { accent: 'belgian', ipa: 'dɔne ku də pje' }
  ], category: 'verbs', examples: ['Donne un coup de pied au ballon.', 'Il a donné un coup de pied à la porte.'] },
  { id: 'word_mordre', word: 'mordre', meaning: 'to bite', pronunciationVariants: [
    { accent: 'parisian', ipa: 'mɔʁdʁ' },
    { accent: 'quebecois', ipa: 'mɔʁdʁ' },
    { accent: 'belgian', ipa: 'mɔʁdʁ' }
  ], category: 'verbs', examples: ['Ne mords pas tes ongles.', 'Le chien l\'a mordu.'] },
  { id: 'word_choisir', word: 'choisir', meaning: 'to choose', pronunciationVariants: [
    { accent: 'parisian', ipa: 'ʃwaziʁ' },
    { accent: 'quebecois', ipa: 'ʃwaziʁ' },
    { accent: 'belgian', ipa: 'ʃwaziʁ' }
  ], category: 'verbs', examples: ['Choisis sagement.', 'Elle a choisi le rouge.'] },
  { id: 'word_aimer', word: 'aimer', meaning: 'to like/love', pronunciationVariants: [
    { accent: 'parisian', ipa: 'ɛme' },
    { accent: 'quebecois', ipa: 'ɛme' },
    { accent: 'belgian', ipa: 'ɛme' }
  ], category: 'verbs', examples: ['J\'aime le chocolat.', 'Elle aime lire.'] },
  { id: 'word_detester', word: 'détester', meaning: 'to hate', pronunciationVariants: [
    { accent: 'parisian', ipa: 'deteste' },
    { accent: 'quebecois', ipa: 'deteste' },
    { accent: 'belgian', ipa: 'deteste' }
  ], category: 'verbs', examples: ['Je déteste attendre.', 'Il déteste perdre.'] },
  { id: 'word_adorer', word: 'adorer', meaning: 'to love/adore', pronunciationVariants: [
    { accent: 'parisian', ipa: 'adɔʁe' },
    { accent: 'quebecois', ipa: 'adɔʁe' },
    { accent: 'belgian', ipa: 'adɔʁe' }
  ], category: 'verbs', examples: ['Je t\'adore.', 'Elle adore le chocolat.'] }
];
